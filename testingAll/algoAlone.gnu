...
fit f(x) '/home/acki/CLionProjects/sortingAlgo/testingAll/heap_sort.csv' via c
...
#### Plot both data and function (data with points)
 plot '/home/acki/CLionProjects/sortingAlgo/testingAll/heap_sort.csv' title 'data', f(x) title title_f(c) with lines linestyle 2
