...
# Set names of stuff
set title "Execution Time vs Complexity bubble sort V2 croissant"
...
fit f(x) '/home/acki/Documents/Projet-final/bubble_sort_croissant_V2/bubble_sort_croissantV2.csv' via c
...
#### Plot both data and function (data with points)
 plot '/home/acki/Documents/Projet-final/bubble_sort_croissant_V2/bubble_sort_croissantV2.csv' title 'data', f(x) title title_f(c) with lines linestyle 2
