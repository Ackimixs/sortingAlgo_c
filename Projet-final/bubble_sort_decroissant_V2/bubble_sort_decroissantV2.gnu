...
# Set names of stuff
set title "Execution Time vs Complexity bubble sort decroissant"
...
fit f(x) '/home/acki/Documents/Projet-final/bubble_sort_decroissant_V2/bubble_sort_decroissantV2.csv' via c
...
#### Plot both data and function (data with points)
 plot '/home/acki/Documents/Projet-final/bubble_sort_decroissant_V2/bubble_sort_decroissantV2.csv' title 'data', f(x) title title_f(c) with lines linestyle 2
