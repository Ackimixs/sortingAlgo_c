...
#### Plot data only
# plot '/home/acki/Documents/Projet-final-20220919/counting_sort.csv' title 'data'

#### Plot both data and function (data with continuous line)
# plot '/home/acki/Documents/Projet-final-20220919/counting_sort.csv' title 'data' with lines linestyle 1, f(x) title title_f(c) with lines linestyle 2

#### Plot both data and function (data with points)
 plot '/home/acki/Documents/Projet-final-20220919/counting_sort.csv' title 'data', f(x) title title_f(c) with lines linestyle 2
